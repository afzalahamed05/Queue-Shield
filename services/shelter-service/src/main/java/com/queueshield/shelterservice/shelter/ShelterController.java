...
import com.queueshield.shelterservice.common.PageResponse;
...
public class ShelterController {
    ...
    @GetMapping("/summary")
    public ShelterCapacitySummaryResponse summary() {
        long[] c = shelterService.capacitySummary();
        return new ShelterCapacitySummaryResponse(c[0], c[1], c[2]);
    }
